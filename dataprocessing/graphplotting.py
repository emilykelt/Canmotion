...
import io
#As is, this code will produce three graphs, X_Acceleration against Time, as well Y_Acceleration and Z_Acceleration against Time.
...
y = table_1['X_Acceleration'].to_numpy()
# Graph dimensions
xmin = x.min()
xmax = x.max()
ymin = y.min() - 5
...
y = table_1['Y_Acceleration'].to_numpy()
...
y = table_1['Z_Acceleration'].to_numpy()
